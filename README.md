...
| `display/` | LCD dashboard with four themes — Classic (auto day/night), Terminal (Fallout-style: scanlines, glitch, boot sequence, VU/vitals panel, optional mascot at `/opt/pi-speakers/mascot.png` — not bundled), Neon, Retro TV |
